...
const AuthPage = () => {
  ...
  const { signIn, signUp, signInWithGoogle, signInWithMicrosoft, session } = useAuth();
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50 dark:bg-slate-950">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">Welcome to MainGallery</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Button variant="outline" type="button" onClick={handleMicrosoftSignIn} className="flex items-center justify-center gap-2">
